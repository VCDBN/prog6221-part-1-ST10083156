  ...
  static  int numIngredients = 0;
   static int numOfSteps = 0;
    ...
    static void newRecipe()
    {
        ...
        Ingredient ingredient = new Ingredient(numIngredients);
        ...
        for (int i = 0; i < numIngredients; i++)
        {
            ...
            ingredient.addIngredient(i, name, unitOfMeasurement, quantity);
        ...
        steps.listOfSteps = new string[numOfSteps];
        ...
        display(numIngredients, numOfSteps, ingredient, steps);

        menu(numIngredients, numOfSteps, ingredient, steps);
    }
   //method for printing the ingredients and steps
    ...
    {
        if (ingredient.NameArray[0] == null)
        {
            Console.WriteLine(" ");
        ...
        else
        {
            ...
            {
                Console.WriteLine(" ");
                Console.WriteLine($"{ingredient.QuantityArray[i]} {ingredient.UnitArray[i]} of {ingredient.NameArray[i]}");
    ...
    static void menu(int numIngredients, int numOfSteps, Ingredient ingredient, Steps steps)
    {
        ...
        switch (input)
        {
            ...
            case 4:
                Console.WriteLine(" ");
                if (ingredient.NameArray[0] == null) { Console.WriteLine("Recipe book is already empty."); }
                else
                {
            ...
            case 5:
                ...
                numOfSteps = 0;
                Console.WriteLine(" ");
                if (ingredient1.NameArray[0] != null)
                {
